...
class AdminController extends Controller
{
    ...
    public function Admin_updEmp(Request $request){
        $employee = new Employee();
        $carbonDate = \Carbon\Carbon::parse($request->date5)->format('Y-m-d H:i:s');
        $carbonDate2 = \Carbon\Carbon::parse($request->date6)->format('Y-m-d H:i:s');
        $sel=3;
    ...
    public function updAppoAdm(Request $request){
        ...
        $id_appo = $request->input('id_appo');
        $date = \Carbon\Carbon::parse($request->input1)->format('Y-m-d H:i:s');
