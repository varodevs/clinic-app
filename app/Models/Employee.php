...
class Employee extends Model
{
	 ...
	 */
	public function createEmployee($name_emp, $title, $title_court, $date_birth, $date_hire, $id_user,$img_path){
		$result = DB::table('employee')->insert(array('name_emp'=> $name_emp, 'title'=>$title, 'title_court'=>$title_court, 'date_birth'=>$date_birth, 'date_hire'=>$date_hire, 'user_id_user'=>$id_user,'img_path'=>$img_path));
		return $result;
	}
