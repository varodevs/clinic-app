<div class="col-3 align-self-center m-3">
    <form action="#" method="POST" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Last name" aria-label="ID" aria-describedby="basic-addon1" value="{{ $carbonDate = \Carbon\Carbon::createFromFormat('Y/m/d', $employee->date_birth); }}" disabled>
        </div>
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Date hired</span>
            <input type="text" class="form-control" placeholder="Last name" aria-label="ID" aria-describedby="basic-addon1" value="{{ $carbonDate = \Carbon\Carbon::createFromFormat('Y/m/d', $patient->date_hire); }}" disabled>
        </div>
        <div class="input-group mb-3">
