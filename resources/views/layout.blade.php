              ...
              <div class="d-flex align-self-center w-75 _nav-contacto">
                ...
                <div class="d-flex h-75">
                  @if (Route::has('login'))
                    ...
                    @else
                    <a href="{{ route('login') }}" class="_link w-75 text-center text-nowrap"><button class="btn btn-light mx-1 p-1">Sign in</button></a>
                    @endif                    
                  @endif
                  @if (Route::has('register'))
                  <a href="{{ route('register') }}" class="_link w-75 text-center text-nowrap"><button class="btn btn-light mx-1 p-1">Sign up</button></a>
                  @endif
                </div>
              </div>
            </div>
