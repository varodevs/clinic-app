        ...
        <div class="d-flex justify-content-evenly _footer">
            ...
            <div class="d-flex flex-nowrap w-25">
                <ul class="nav justify-content-evenly flex-nowrap">                
                    <li class="nav-item">
                      <a class="nav-link d-flex flex-column justify-items-center h-100" href="https://www.facebook.com/" target="_blank"><i class="fab fa-facebook"></i></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link d-flex flex-column justify-items-center h-100" href="https://www.twitter.com/" target="_blank"><i class="fab fa-twitter"></i></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link d-flex flex-column justify-items-center h-100" href="https://www.instagram.com/" target="_blank"><i class="fab fa-instagram"></i></a>
                    </li>
                  </ul>
            </div>
        </div>
