...
<div class="col-12">
  <div class="container-fluid d-flex flex-column justify-content-center _div-azul" id="section">
    ...
    <div class="container-fluid d-flex flex-column align-items-center pt-5">
        ...
        <div class="text-center w-75"><p>In VitalCore we have several servides available to cover all your needs and ensure you receive a specialized treatment.</p></div>
    </div>
