...
<div class="col-12">
    ...
    <div class="c-12 d-flex flex-column align-items-center pt-5" mb-5>
        ...
        <div  class="c-12 d-flex justify-content-evenly pt-5">
            ...
            <div class="w-25"><p class="_carou-p">Welcome to VitalCore, where we are dedicated to helping you achieve optimal physical health and well-being. With a team of highly skilled and compassionate physiotherapists, we provide personalized care and evidence-based treatments to address a wide range of musculoskeletal and movement-related conditions.</p></div>
        </div>
    </div>
