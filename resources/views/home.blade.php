            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <div class="c-3 d-flex flex-column align-self-center text-center">
                        ...
                        <p class="_carou-p">Recover using movement and physical activity to improve and restore functional abilities.</p>
                    </div>                    
                </div>
                <div class="carousel-item">
                    <div class="c-3 d-flex flex-column align-self-center text-center">
                        ...
                        <p class="_carou-p">Take care of yout musculoskeletal.</p>
                    </div>
