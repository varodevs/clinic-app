...
<div class="col-12">
    ...
    <div class="col-12 d-flex flex-column">
        ...
        <div class="col-3 align-self-center m-3">
            <h3 class="_h3">New Employee</h3>
            <form action="{{ route('admin-new-emp') }}" method="POST">
                @csrf
                <div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="tcourt" placeholder="Title courtesy" aria-label="ln" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" name="hdate" aria-label="ln" aria-describedby="basic-addon1">
                </div>
